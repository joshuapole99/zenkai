...
- [ ] Custom workout selection: user picks their own exercises per session (not hardcoded)
- [ ] Daily food log: full meal input with protein/calories (replaces yes/no check)
- [ ] Anime story mode: personal story that evolves with training — each level unlock = new story chapter
...
## Build Priority
1. Fix bugs
2. Body stats + protein calculator
3. Zenkai Boost mechanic
4. Custom workout selection
5. Full food tracking
6. Lemon Squeezy payments
7. Resend emails
8. Anime story mode
9. Character visual evolution
10. Push notifications
11. Leaderboard
12. Co-op mode
13. Custom character creator
